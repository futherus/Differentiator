...
SRC := main.cpp lexer.cpp Array.cpp parser.cpp derivative.cpp cutter.cpp Tree.cpp Tree_dump.cpp article.cpp dumpsystem.cpp Stack.cpp stack_hash.cpp dump.cpp 
OBJ := $(SRC:.cpp=.o)
LIB := iconv
